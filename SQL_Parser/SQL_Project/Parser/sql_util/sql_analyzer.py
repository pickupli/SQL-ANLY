...
demo_sql2 = "SELECT t.abc,t.etf AS fstC,tbl2.ggg FROM (select tbl0.abc as abc  ,tbl1.etf as etf from tbl0,tbl1 where tbl0.aaa=102) t,tbl2 where tbl2.ddd=4 "
demo_sql3 = 'SELECT a,b,c,d,e,f FROM tbl0   WHERE g=2 and c=(select  a1 from tbl1 where b2=3)   group by fff  HAVING AVG(zzz)>900 order by rrr'
